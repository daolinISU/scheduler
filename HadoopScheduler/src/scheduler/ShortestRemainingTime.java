...
{    
    ...
    public Queue<Process> schedule(PriorityQueue<Process> q) 
    {
        ...
        Queue<Process> scheduledQueue = new LinkedList<Process>();
        
        // Need to keep track of these to calculate turnaround and wait times
        Map<String, Integer> startTimes = new HashMap<String, Integer>();
        Map<String, Integer> finishTimes = new HashMap<String, Integer>();
        ...
        PriorityQueue<Process> readyQueue = new PriorityQueue<Process>(10, 
            new Comparator()
            {
                @Override
        ...
        PriorityQueue<Process> waitingQueue = new PriorityQueue<Process>(10, 
            new Comparator()
            {
                @Override
                public int compare(Object o1, Object o2) 
